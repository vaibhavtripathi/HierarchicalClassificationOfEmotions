...
class ClassifierPerParentNode:
	...
	for label in clfclasses.keys():
		clfs[label] = MultinomialNB(fit_prior=False)
		#clfs[label] = LogisticRegression()
...
if __name__=='__main__':
	...
	DATAFILE = 'train_run5_text.txt'
	LABELFILE = 'train_run5_labels.txt'
	TESTFILE = 'test_run5_text.txt'
	OUTFILE = 'pred_run5_'+''.join(ch for ch in sys.argv[1] if ch in '1234567890')+'.txt'
